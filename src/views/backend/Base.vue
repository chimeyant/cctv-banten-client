  ...
  <v-app id="inspire">
    ...
    >
      ...
      <v-list
        ...
        class="rounded-t-xl pt-10 mt-5 animate__animated animate__fadeInUp "
      ...
      >
        <template v-for="(menu, index) in menus">
          ...
          <v-subheader
            :class="menu.class"
            :key="index"
            class="overline mt-3 font-weight-bold black--text white mb-3"
            style="height: 40px; border:green 1px solid; border-radius:5px "
          ...
          <v-subheader
            :class="menu.class"
            :key="index"
            class=" mt-3 border-3 orange--text border-danger font-weight-thin"
            style="height: 24px"
    ...
    >
      ...
      <v-toolbar-title
        ...
        :class="theme.mode ? `green--text`: `green--text ` "
      >{{
        info.app_company
      }}</v-toolbar-title>
